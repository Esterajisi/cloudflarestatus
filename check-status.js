...
const WEBHOOK_URL = process.env.CLOUDFLARE_WEBHOOK;
const CACHE_FILE = 'last_id.txt';

async function checkStatus() {
    try {
        console.log("Fetching RSS feed...");
        const feed = await parser.parseURL('https://www.cloudflarestatus.com/history.rss');
        ...
        if (latestId !== lastId) {
            ...
            await axios.post(WEBHOOK_URL, {
                username: "C_l_o_u_d_f_l_a_r_e Status Monitor",
                embeds: [{
